...
and it routes to each published service by a path prefix. The current reference deployment runs 75 routed backend services behind the gateway and exposes 162 gateway domains.
