...
and it routes to each published service by a path prefix. The current reference deployment runs 72 routed backend services behind the gateway and exposes 143 gateway domains.
