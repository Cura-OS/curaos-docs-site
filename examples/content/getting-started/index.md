...
identity broker, and the app together. The current local reference stack routes 72 services through the gateway and exposes 143 generated `/api/v1` domains.
