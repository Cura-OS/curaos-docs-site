...
identity broker, and the app together. The current local reference stack routes 75 services through the gateway and exposes 162 generated `/api/v1` domains.
