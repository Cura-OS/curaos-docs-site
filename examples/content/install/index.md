...
curl -i https://<your-host>/identity/healthz
```
...
```bash
curl -s https://<your-host>/identity/healthz   # 200 when identity is up
curl -s https://<your-host>/tenancy/healthz    # 200 when tenancy is up
```
